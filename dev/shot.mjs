...
if (action === 'drawer') { await p.click('[data-m-open="m-drawer"]'); await p.waitForTimeout(400); }
if (action === 'search') { await p.click('[data-m-open="m-search"]'); await p.waitForTimeout(300); }
